...
import FMALogo from '@images/logo.svg'
import content from '../../../content/pages/quickStart.json'
...
export default function QuickstartPage(): ReactElement {
  const { title, topSection, hero, footer, image }: QuickstartContent = content
